...
if ( ! function_exists( 'quest_setup' ) ) :
	...
	function quest_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'quest' ),
		) );
 ...
 */
function quest_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'quest_content_width', 640 );
}
...
function quest_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'quest' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'quest' ),
...
function quest_scripts() {
	...
	wp_enqueue_script( 'quest-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'quest-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	// Adding in our own custom scraper script
	wp_enqueue_script( 'quest-api', get_template_directory_uri() . '/js/quest-api.js', array(), '20151215', true );
	wp_enqueue_script( 'stars', get_template_directory_uri() . '/js/stars.js', array(), '20151215', true );
...
function your_prefix_meta_boxes( $meta_boxes ) {
    $meta_boxes[] = array(
        ...
        'fields'     => array(
            array(
                'id'   => 'goFundMeUrl',
                'name' => __( 'GoFundMe URL', 'textdomain' ),
                'type' => 'text',
            ),
        ),
    );
